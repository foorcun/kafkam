...
echo classname: > logy.txt
echo %1 >> logy.txt

echo ikinci argument >> logy.txt
echo %2 >> logy.txt

echo oncul argument1 >> logy.txt
echo %KAFKA_LOG4J_OPTS% >> logy.txt

echo oncul argument2 >> logy.txt
echo %KAFKA_HEAP_OPTS% >> logy.txt
...
echo KAFKA_JVM_PERFORMANCE_OPTS >> logy.txt
echo %KAFKA_JVM_PERFORMANCE_OPTS% >> logy.txt
